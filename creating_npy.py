...
main_folder_path = 'E:/stm/Actions_keypoints/'
output_folder_path = 'E:/stm/Actions_keypoints/'
...
for root, dirs, files in os.walk(main_folder_path):
    for folder_name in dirs:
        ...
        print(f"Saved data for folder {folder_name} with shape {concatenated_data.shape}")
